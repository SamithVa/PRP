...
const byte pumpSignal = 5;

// // TWO PUMPS WATER IN : DIGITAL
const byte pumpOut = 11;

// // ONE PUMP WATER OUT : DIGITAL
const byte pumpIn = 12;

// Actuator 
// const byte actuatorSignal = 6; // PWM

// const byte actuatorA = 28; // DIGITAL
// const byte actuatorB = 32; // DIGITAL
...
const int propellerMaxSpeed = 180;
const int propellerMinSpeed = 0;
...
// Function to calibrate and calculate propeller speeds based on joystick input
speed calibratePropellerSignal(int raw_x, int raw_y)
{
